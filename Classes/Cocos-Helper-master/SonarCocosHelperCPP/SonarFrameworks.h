...
public:
     ...
     */
    static void Share( __String shareString, __String imagePath );
};
...
public:
     ...
     * @param leaderboardID is the name of your leaderboard
     */
    static void submitScore( int scoreNumber, __String leaderboardID );
    /**
     * Unlock achievement
     * @param achievementID is the achievement to unlock
     */
    static void unlockAchievement( __String achievementID );
    /**
     * Unlock percentage of an achievement
     * @param achievementID is the achievement to increment
     * @param percent is the percentage of the achievement to unlock
     */
    static void unlockAchievement( __String achievementID, float percent );
    /**
...
public:
     ...
     */
    static void setScreenName( __String screenName );
    /**
     ...
     */
    static void sendEvent( __String category, __String action, __String label, long value );
};
...
public:
     ...
     * @param shareString is the string to share
     */
    static void shareTextToWeChat( __String shareString );
    /**
     ...
     */
    static void shareLinkToWeChat( __String thumbImgPath , __String msgTitle , __String msgDescription , __String httpUrl);
     ...
     */
    static void shareMusicToWeChat( __String msgTitle , __String msgDescription , __String thumbImgPath , __String musicUrl , __String musicDataURL);
    ...
    static void shareVideoToWeChat( __String msgTitle , __String msgDescription , __String thumbImgPath , __String videoUrl);
};
...
{
public:
    static void sendLogEvent(__String eventId);
    static void sendLogEvent(__String eventId,bool timed);
    static void endLogEvent(__String eventId);
};
