...
void IOS::Share( __String shareString, __String imagePath )
{
...
void GameCenter::submitScore( int scoreNumber, __String leaderboardID )
{
#if SCH_IS_GAME_CENTER_ENABLED == 1 && CC_TARGET_PLATFORM == CC_PLATFORM_IOS
...
void GameCenter::unlockAchievement( __String achievementID )
{
#if SCH_IS_GAME_CENTER_ENABLED == 1 && CC_TARGET_PLATFORM == CC_PLATFORM_IOS
...
void GameCenter::unlockAchievement( __String achievementID, float percent )
{
#if SCH_IS_GAME_CENTER_ENABLED == 1 && CC_TARGET_PLATFORM == CC_PLATFORM_IOS
...
void GoogleAnalytics::setScreenName( __String screenName )
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
    return JniHelpers::jniCommonVoidCall(
               "SetGAScreenName",
...
void GoogleAnalytics::sendEvent( __String category, __String action, __String label, long value )
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
    return JniHelpers::jniCommonVoidCall(
               "SendGAEvent",
...
void UI::AudioTouchEvent( Ref *sender, Widget::TouchEventType type )
{
    ...
    case Widget::TouchEventType::ENDED:
        ...
        if ( AudioEngine::AudioEngineThreadPool > 0.0f )
        {
            volume = 0.0f;
...
void WeChat::shareTextToWeChat( __String shareString )
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
#elif(CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
...
void WeChat::shareImageToWeChat( __String thumbImgPath, __String imgPath )
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
#elif(CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    #if SCH_IS_WECHAT_ENABLED == 1
...
void WeChat::shareLinkToWeChat( __String thumbImgPath, __String msgTitle, __String msgDescription, __String httpUrl )
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
#elif(CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    #if SCH_IS_WECHAT_ENABLED == 1
...
void WeChat::shareMusicToWeChat( __String msgTitle, __String msgDescription, __String thumbImgPath, __String musicUrl, __String musicDataURL )
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
#elif(CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    #if SCH_IS_WECHAT_ENABLED == 1
...
void WeChat::shareVideoToWeChat( __String msgTitle, __String msgDescription, __String thumbImgPath, __String videoUrl )
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
#elif(CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    #if SCH_IS_WECHAT_ENABLED == 1
...
void Notifications::scheduleLocalNotification( float delay, __String textToDisplay, __String notificationTitle , int notificationTag )
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
#elif(CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
...
void Notifications::scheduleLocalNotification( float delay, __String textToDisplay, __String notificationTitle, __String notificationAction , int notificationTag )
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
#elif(CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    #if SCH_IS_NOTIFICATIONS_ENABLED == 1
...
void Notifications::scheduleLocalNotification( float delay, __String textToDisplay, __String notificationTitle, int repeatInterval , int notificationTag )
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
#elif(CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    #if SCH_IS_NOTIFICATIONS_ENABLED == 1
...
void Notifications::scheduleLocalNotification( float delay, __String textToDisplay, __String notificationTitle, __String notificationAction, int repeatInterval , int notificationTag )
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
#elif(CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
    #if SCH_IS_NOTIFICATIONS_ENABLED == 1
...
void FlurryAnalytics::sendLogEvent(__String eventId)
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
    JniHelpers::jniCommonVoidCall("SendLogEvent",CLASS_NAME,eventId.getCString());
#endif
}
void FlurryAnalytics::sendLogEvent(__String eventId, bool timed)
{
#if(CC_TARGET_PLATFORM==CC_PLATFORM_ANDROID)
    JniHelpers::jniCommonIntCall("SendLogEvent",CLASS_NAME,eventId.getCString(),timed);
#endif
}
void FlurryAnalytics::endLogEvent(__String eventId)
{
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
